<template>
	<view class="content">
		<view class="product-container">
			...
			<view class="card-container">
				<view class="card-content">
					<image
						src="https://img0.baidu.com/it/u=3848144581,838548300&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=889"
						class="card-image" @click="previewImage" />
				</view>
				<view class="card-tail"></view>
			</view>
			<view class="title">
				F:NEX VOCALOID 初音未来 魔法未来 hhhhhhhh 2020 Summer Ver
			</view>
			<view class="price">不要钱，免费送</view>
			<!-- <view class="share-btn" @tap="handleShare"> 分享好友获更多抽奖机会 </view> -->
			<button class="share-btn" @tap="getUserProfile">分享好友获更多抽奖机会</button>
			<!-- <button class="share-btn" bindtap="getUserProfile"> 获取头像昵称 </button> -->
		...
		<view class="overlay" @touchmove.stop.prevent="moveHandle" @tap="showPosterOverlay = false"
			v-if="showPosterOverlay">
			<poster :poster-params="posterParams" @close-overlay="showPosterOverlay = false" />
		</view>
	</view>
</template>
